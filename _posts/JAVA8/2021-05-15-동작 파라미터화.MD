...
![동작 파라미터화.png](https://github.com/kujaHn/kujaHn.github.io/blob/master/image/java8/ch2/ch2_1.png)
...
![동작 매커니즘.png](https://github.com/kujaHn/kujaHn.github.io/blob/master/image/java8/ch2/ch2_2.png)

#### 학생 기록부 V4 - 익명클래스 적용
* 핵심 개념은 다 설명했으나, 조금 더 간략화 해보자.
* 우리가 불편한 점은, 전략 패턴 클래스들을 따로 생성을 하고, 또 인스턴스를 만들어 파라미터로 넣는 것이다.
* 이는 `익명 클래스`를 통해서 해결할 수 있다.
    ![익명클래스 적용.png](https://github.com/kujaHn/kujaHn.github.io/blob/master/image/java8/ch2/ch2_3.png)
