...
* 이렇게 **처리 과정이 열고 닫는 순서 사이에 있는 패턴을 `실행 어라운드 패턴`이라고 한다.**
  ...
  * 원래라면 매번 다른 요청마다 **매번 열고 닫는 과정을 반복해서 코드를 짜야 한다.**
    ...
    ![실행 어라운드 패턴의 전략화.png](https://github.com/kujaHn/kujaHn.github.io/blob/master/image/JAVA8/ch3/ch3_3.png)
...
![img.png](https://github.com/kujaHn/kujaHn.github.io/blob/master/image/JAVA8/ch3/ch3_4.png)
