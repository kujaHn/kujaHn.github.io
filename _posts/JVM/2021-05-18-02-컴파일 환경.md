...
# 컴파일 환경
<img src="/image/JVM/ch2/architecture-of-jvm.png" alt="클래스파일 생성.png" class="align-center">
...
### 바이트코드 구조
<img src="/image/JVM/ch2/bytecode-arr.png" alt="바이트코드 구조.png" class="align-center">

<img src="/image/JVM/ch2/bytecodeoverview.png" alt="바이트코드 Overview.png" class="align-center">
#### 매직넘버
...
* <img src="/image/JVM/ch2/UnsupportedClassVersionError.png.png" alt="UnsupportedClassVersionError.png" class="align-center">
...
public class HelloWorld{
    Code:
       0: aload_0               // 생성자에서 this 레퍼런스를 스택 상단에 올림.
       1: invokespecial     #1  // 인스턴스 메소드 실행 (슈퍼생성자 호출, 객체 생성) 여기서는 java/lang/Object
       4: return
    public static void main(String[] args){
       0: iconst_0              // 정수형 상수 0을 평가 스택에 푸시
       1: istore_1              // 상수 값을 오프셋 1에 위치한 지역 변수(루프문의 i)에 저장, 0번째는 this
       2: iload_1               // 오프셋 1에 위치한 지역 변수를 스태긍로 로드
       3: bipush            10  // 상수 10 푸시 (i<10)
       5: if_icmpge         20  // 비교 (i가 10보다 큰가?)  (실패시 8번, 성공시 22번으로)
       8: getstatic         #2  // 정적 메소드(System.out) 해석 
       11: ldc              #3  // 상수 풀에서 "Hello world" 로드
       13: invokevirtual    #4  // 인스턴스 메소드 실행
       16: iinc             1, 1    // 정수값(i) 1 증가
       19: goto             2   // 2번 명령으로 되돌아 가라
       22: return               // 5번의 if_icmpge가 성공하면 반환
    }
}
```
## 참고&출처
